<!-- <footer class="text-muted bg-dark py-3">
    ...
    <p class="float-end mb-1">
        <a href="#" class="text-white">Ir arriba</a>
    </p>
    <p class="mb-1">Album example is &copy; Bootstrap, but please download and customize it for yourself!</p>
    <p class="mb-0">New to Bootstrap? <a href="/" class="text-white">Visit the homepage</a> or read our <a href="../getting-started/introduction/" class="text-white">getting started guide</a>.</p>
    </div>
</footer> -->
...
<footer class="bg-dark text-center text-white">
  ...
  <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
    © 2022 Copyright:
    <a class="text-white" href="https://virgala.com.ar">Virgala</a>
  </div>
  <!-- Copyright -->
</footer>